      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Mr.Stark"}
              </Heading>
              <Text color={"gray.500"}>
                {about.role
                  ? about.role
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "stark@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+918574214965"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Bangalore, IN"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                ...
                {educationList.map((education) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"}>
                        {school ? school : "College of Engineering Bangalore"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        ...
                        <Text>{grade ? grade : "9.2 CGPA"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"xs"} fontStyle={"italic"}>
                        ...
                        {endDate ? endDate : "2022-12"}
                      </Text>
                      <Text fontSize={"sm"} as="p">
                        {desc
                          ? desc
                          : "Developed relationships with business owners, Managed Ground Operations, Provided Customer Services."}
                      </Text>
                    </VStack>
                  );
                })}
                    ...
                    >
                      <HStack as="a" href={url} target="_blank" spacing={0.5}>
                        <Text fontWeight={"medium"} flex={"row"}>
                          {name ? name : "Social Media Application"}{" "}
                        </Text>{" "}
                        <BiLinkExternal />
                      </HStack>
                      <UnorderedList pl={5}>
                        <ListItem>
                          <Text fontSize={"sm"} as="p">
                            {desc
                              ? desc
                              : "Built a application were user can interect with their friends and families with their photos and posts."}
                          </Text>
                        </ListItem>
                      </UnorderedList>
                    </VStack>
